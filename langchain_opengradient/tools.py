...
class OpenGradientToolInput(BaseModel):
    """Input schema for OpenGradient tool.
...
class OpenGradientTool(BaseTool):  # type: ignore[override]
    """OpenGradient tool.
    ...
    args_schema: Type[BaseModel] = OpenGradientToolInput
