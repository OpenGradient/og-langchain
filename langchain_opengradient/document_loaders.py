...
class OpenGradientLoader(BaseLoader):
    ...
    """
    OpenGradient document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import OpenGradientLoader

            loader = OpenGradientLoader(
                # required params = ...
                # other params = ...
            )
