...
class OpenGradientRetriever(BaseRetriever):
    ...
    """OpenGradient retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-opengradient`` and set environment variable
        ``OPENGRADIENT_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-opengradient import OpenGradientRetriever

            retriever = OpenGradientRetriever(
                # ...
            )
