...
class ChatOpenGradient(BaseChatModel):
    ...
    """OpenGradient chat model integration.
    ...
    Key init args — completion params:
        model: str
            Name of OpenGradient model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            OpenGradient API key. If not passed in will be read from env var OPENGRADIENT_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatOpenGradient.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatOpenGradient.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatOpenGradient supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatOpenGradient supports async generation. Otherwise delete.
